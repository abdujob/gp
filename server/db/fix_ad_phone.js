...
async function fixAdPhone() {
    console.log("🔌 Connecting to database...");

    try {
        // Correct description as requested: just "0788246184"
        const newDescription = "Marseille dakar le 8 fevrier numero etelephone pour le whatsap:0788246184";
